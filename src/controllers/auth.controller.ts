...
export const requestEmailOtpHandler = asyncHandler(async (req: Request, res: Response) => {
  const { email } = req.body;
  const data = await requestEmailOtp(email);
  res.json({ success: true, data });
});

export const requestPhoneOtpHandler = asyncHandler(async (req: Request, res: Response) => {
  const { phone } = req.body;
  const data = await requestPhoneOtp(phone);
  res.json({ success: true, data });
});

export const verifyEmailOtpHandler = asyncHandler(async (req: Request, res: Response) => {
...
export const verifyPhoneOtpHandler = asyncHandler(async (req: Request, res: Response) => {
